...
- Payment terms: `payment_terms_days` is the net days for the balance. `prepayment_percent` is the share due before shipment (deposit, advance, or cash in advance); use 0 when none is stated.
